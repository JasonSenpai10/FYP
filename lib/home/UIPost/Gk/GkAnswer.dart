...
class GkAnswer extends StatefulWidget {
  final GkQuery query;
  GkAnswer(this.query);

  @override
  State<GkAnswer> createState() => _GkAnswerState();
}

class _GkAnswerState extends State<GkAnswer> {
        ...
        child: Column(
          children: [
            Card(
              color: Colors.blue,
              child: ListTile(
                title: Text(widget.query.gkquery),
              ),
            ),
            SizedBox(
              height: 20,
            ...
            ElevatedButton(
              onPressed: () async {
                Uri url = Uri.parse(baseUrl + "gkanswer.php");
                ...
                if (answer.text == "") {
                  ...
                  if (data == "Success") {
                    ...
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => Gk()));
                  } else {
                    Fluttertoast.showToast(
                        msg: "Submit failed",
                        toastLength: Toast.LENGTH_SHORT,
